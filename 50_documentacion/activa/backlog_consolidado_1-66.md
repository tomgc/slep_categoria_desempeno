# Backlog acumulativo consolidado (1-66) — slep_categoria_desempeno
...
> referencia ("copiar íntegro 1-54/1-58/1-62") desde el v11. Cada una de las 66
> entradas queda reproducida como entrada autónoma, no referenciada. Granularidad:
...
|---|---|---|---|
| Diseño UI — Motor base y diseño | 13 | 20 | Diseño de visualización (v01, c.11); motor HTML paso 33 base + iteraciones UI 1-4 (v03, c.17-21); publicación Pages en el generador (v04, c.26); tarjetas de modo territorio con estudiantes + % (v10, c.49); estandarización tipográfica por tokens (v10, c.54); convivencia año de matrícula (v12, c.59); desglose por grado en motor (v12, c.61); bloque narrativo territorial parcial (v12, c.62); D21 template regenerado desde referencia UI (v13, c.63) |
| Scaffold e inicialización | 12 | 18 | Estructura, scaffold, utils, escáner, gitignore, rproj/readme, protocolo, decisiones, git (v01, c.1-9 salvo orquestación); auditoría seguridad, gobernanza, LICENSE, CI, README migración (v04, c.22-25,27) |
| Diseño UI — Hoja comparativa | 9 | 14 | Comparativa, multi-selección, límites, lotes visuales (v05, c.28,30-35); botón limpiar (v07, c.41); N EE + tooltip de estudiantes/% (v10, c.50) |
...
| Documentación de proyecto | 5 | 8 | Decisiones (v01, c.8); 5 archivos de decisión (v06, c.37); reconciliación de taxonomía (v07, c.42); decisión taxonomía-meta (v08, c.44); materialización del backlog v10 (v11, c.56) |
...
| Migración y publicación / DevOps | 1 | 2 | Recuperación de la sesión 10 en Git (v11, c.55) |
| Validación / integridad | 1 | 2 | Check 6.5 de partición territorial (v13, c.66) |
| Calidad de código / pipeline | 1 | 2 | Warning de readLines silenciado de raíz (v13, c.64) |

(Nota de conteo: el detalle cronológico es la fuente de verdad y tiene 66 entradas
(1-66). La tabla temática suma 66, cuadrando con el cronológico, con asignación por
intención primaria verificada entrada por entrada. La categoría líder, "Diseño UI —
Motor base y diseño", queda en 20% (13/66), bajo el umbral de subdivisión del 25%.
Tres categorías nuevas de v13 quedan en una entrada cada una (~2%): se conservan por
intención primaria distinta y por ser el inicio probable de familias futuras
(validación, calidad de pipeline, DevOps), no se absorben aún. Se unifican "Scaffold
inicial" (v10) y la inicialización de v04 bajo "Scaffold e inicialización" (12),
criterio consistente con la sección 4 de los traspasos de origen; las entradas de
naturaleza de orquestación del scaffold (c.2, stub) se imputan a "Orquestación" por
...
## Delta del backlog (consolidación v13 → documento in extenso)

Esta consolidación NO agrega cambios nuevos (el detalle sigue en 66). Materializa el
detalle cronológico completo 1-66 como entradas autónomas, cerrando
DT-backlog-documental. Antes, las entradas 1-48 se arrastraban como resumen de una
línea por sesión y 49-66 vivían dispersas en sus traspasos de origen; ahora las 66
quedan reproducidas en un solo lugar. Refinamiento de taxonomía: se unifican
"Scaffold inicial" (v10) y la inicialización de v04 bajo "Scaffold e inicialización"
(9), y se incorporan a la tabla las tres categorías nuevas de v13 (Validación /
integridad, Calidad de código / pipeline, Migración y publicación / DevOps). La
categoría líder baja a 24% (16/66), bajo el umbral de subdivisión. Cero
reclasificaciones de entradas individuales; cero renumeraciones.
