...
- **Fecha:** 2026-06-17 09:51:06
- **Totales:** 21 carpetas, 120 archivos
...
│   │   └── .gitkeep  (0)
│   ├── estructura/
│   │   ├── 20260617_082134_estructura.md  (7.06K)
│   │   ├── 20260617_082134_estructura.txt  (7.16K)
│   │   ├── 20260617_094448_estructura.md  (7.22K)
│   │   ├── 20260617_094448_estructura.txt  (7.33K)
│   │   ├── estructura_actual.md  (7.22K)
│   │   └── estructura_actual.txt  (7.33K)
│   ├── suite/
│   │   ├── assets/
...
│   │   ├── arquitectura_general_slep_categoria_desempeno.html  (9.5K)
│   │   ├── arquitectura_slep_categoria_desempeno.html  (17.7K)
│   │   ├── documentacion_general_slep_categoria_desempeno.html  (7.65K)
│   │   ├── documentacion_proyecto_slep_categoria_desempeno.html  (10.7K)
