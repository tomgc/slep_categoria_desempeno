...
- **Fecha:** 2026-06-18 21:56:05
- **Totales:** 21 carpetas, 125 archivos
...
│   │   ├── .DS_Store  (8K)
│   │   ├── backlog_consolidado.md  (62.8K)
│   │   ├── gobernanza_datos.md  (3.04K)
│   │   ├── P-matricula-actual_alcance.md  (3.08K)
│   │   ├── P-matricula-grado_alcance.md  (4.85K)
│   │   ├── POLITICA_PROYECTO.md  (29.7K)
│   │   └── SETTINGS_Y_PROMPTS_OPERACIONALES.md  (31.9K)
│   ├── andamios/
│   │   └── .gitkeep  (0)
│   ├── estructura/
│   │   ├── 20260618_191615_estructura.md  (7.46K)
│   │   ├── 20260618_191615_estructura.txt  (7.57K)
│   │   ├── 20260618_211742_estructura.md  (7.53K)
│   │   ├── 20260618_211742_estructura.txt  (7.63K)
│   │   ├── estructura_actual.md  (7.53K)
│   │   └── estructura_actual.txt  (7.63K)
│   ├── suite/
│   │   ├── assets/
...
│   │   ├── arquitectura_slep_categoria_desempeno.html  (18.3K)
│   │   ├── documentacion_general_slep_categoria_desempeno.html  (7.95K)
│   │   ├── documentacion_proyecto_slep_categoria_desempeno.html  (11.1K)
